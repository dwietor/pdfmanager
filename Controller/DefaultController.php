...
class DefaultController extends Controller {
     ...
     * @Template("DWietorPmanagerBundle:Default:index.html.twig")
     */
...
// Add Javascript code
     ...
     * @Template("DWietorPmanagerBundle:Default:getTemplate.html.twig")
     */
    ...
    public function viewAction($entityName) {
        $entity = $this->getDoctrine()
                ->getRepository('DWietorPmanagerBundle:PDFTemplate')
