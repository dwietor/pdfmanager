...
namespace DWietor\Bundle\PmanagerBundle\Controller\Api\Rest;
...
use DWietor\Bundle\PmanagerBundle\Provider\VariablesProvider;
...
class PDFTemplateController extends RestController
{
    ...
    public function cgetAction($entityName = null)
    {
        ...
        $pdfTemplateRepository = $this->getDoctrine()->getRepository('DWietorPmanagerBundle:PDFTemplate');
    ...
    public function getVariablesAction($entityName = null , $custom = '0')
    {
        ...
        $provider = $this->get('d_wietor_pmanager.pdftemplate.variable_provider');
    ...
    {
        return $this->get('d_wietor_pmanager.pdftemplate.api');
    }
    ...
    {
        return $this->get('d_wietor_pmanager.form.type.pdftemplate.api');
    }
    ...
    {
        return $this->get('d_wietor_pmanager.form.handler.pdftemplate.api');
    }
}
