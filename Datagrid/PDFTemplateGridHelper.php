...
class PDFTemplateGridHelper extends BaseGridHelper
{
    ...
    {
        return [
            'html' => 'dwietor.pmanager.pdftemplate.datagrid.template.filter.type.html',
            'txt'  => 'dwietor.pmanager.pdftemplate.datagrid.datagrid.template.filter.type.txt'
        ];
    }
    ...
    {
        $result            = [];
        $result['_empty_'] = $this->translator->trans('dwietor.pmanager.pdftemplate.datagrid.template.filter.entityName.empty');
